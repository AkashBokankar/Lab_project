	...
	// print_r($name);
		switch($name)
		{
			...
			case "Setting Standard" :
				...
				echo '<div class="database_table"><table class="table table-bordered " id="insrument_add_table" style="text-align: center;"><thead><tr><th scope="col" class="instrument_name">Instrument Name</th></tr></thead><tbody><tr>
				<td width="30%"><label id="instrument_name">'.$key['Name'].'</label></td></tr></tbody></table>
			...
			case "Feeler Gauge" :
			echo '
			<div class="database_table"><table class="table table-bordered " id="insrument_add_table" style="text-align: center;"><thead><tr><th scope="col" class="instrument_name">Instrument Name</th></tr></thead><tbody><tr>
				<td width="30%"><label id="instrument_name">'.$key['Name'].'</label></td></tr></tbody></table>
