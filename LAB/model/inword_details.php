...
if (empty($_POST['instru_size_min'])) {
	$instru_size_min = "NA";
}else{

	$instru_size_min = $_POST['instru_size_min'];
}
if (empty($_POST['instru_size_max'])) {
	$instru_size_max = "NA";
}else{

	$instru_size_max = $_POST['instru_size_max'];
}
...
$query = "INSERT INTO inward_instrument_detail(Lab_id, Instrument_no, Name, Instru_Range, Size_min, Size_max, Make, LC_GRD, LC, ID_no, Qty, Date_Of_Calibration, Certificate_ID, ULR_no, Calibrated_By, Remark) values ('$inword_labid', '$instrument_id', '$instrument_name', '$instru_range','$instru_size_min', '$instru_size_max', '$instru_make', '$instru_lc_grd', '$instru_lc', '$instru_idno', '$instru_qty', '$calib_date', '$cert_id', '$ulr_no', '$calib_by', '$remark')";
